package ru.d3rvich.feature.main.ui
...
enum class TabItems(
    ...
    Browse(
        labelResId = ru.d3rvich.feature.browse.ui.R.string.browse,
        unselectedIconResId = commonR.drawable.search_24px
    ),
    Favorites(
        labelResId = ru.d3rvich.feature.favorites.ui.R.string.feature_favorites_title,
