package ru.d3rvich.feature.screenshots.ui
...
import ru.d3rvich.feature.screenshots.ui.util.SystemBarsController
import ru.d3rvich.feature.screenshots.ui.util.draggableScreenshot
import ru.d3rvich.feature.screenshots.ui.util.rememberDragToDismissState
import ru.d3rvich.feature.screenshots.ui.views.PageIndicator
import ru.d3rvich.feature.screenshots.ui.views.ScreenshotView
...
fun ScreenshotsContent(
    ...
    val showWidgets by component.showWidgets.subscribeAsState()
            ...
            Box(
                modifier = Modifier
                    ...
                    .draggableScreenshot(
                        ...
                        onHeightOffsetChange = { component.setShowWidgets(false) },
                    ...
                    .clickable(
                        ...
                        component.setShowWidgets(!showWidgets)
                    }
            ) {
                val pagerState = rememberPagerState(
                    initialPage = component.currentPage,
                    pageCount = { component.screenshots.size })
                PhotoPager(
                    pagerState = pagerState,
                    dragState = dragState,
                    item = component.screenshots::get,
                    onPageChange = component::safePage
                )
                TopBarWidget(
                    showWidget = showWidgets,
                    onBackPressed = component::onClose,
